let sonido_ganador = new Audio("sonido/ganador.ogg");
let sonido_win = new Audio("sonido/win.ogg");
let sonido_perdedor = new Audio("sonido/perdedor.ogg");
let sonido_gameover = new Audio("sonido/gameover.ogg");
let sonido_descubrir = new Audio("sonido/descubrir.ogg");
let sonido_juegonuevo = new Audio("sonido/nuevojuego.ogg");
let sonido_abrirarea = new Audio("sonido/abrirarea.ogg");
let sonido_marca = new Audio("sonido/marca.ogg");
